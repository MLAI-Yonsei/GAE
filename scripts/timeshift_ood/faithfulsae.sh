#!/bin/bash
# Evaluate FaithfulSAE baseline on Timeshift OOD
# Usage: bash scripts/timeshift_ood/faithfulsae.sh <DEVICE>
...
for OOD_SET in fineweb dolma_web; do
