...
# --wandb_name gpt2_transcoder_erm_lr${lr}_lambda${lambda_sparse}
# done
# done
...
# --use_wandb \
# --wandb_project GAE_ID-training \
# --wandb_name pythia-410m_transcoder_erm_lr${lr}_lambda${lambda_sparse}
# done
# done
...
# --use_wandb \
# --wandb_project GAE_ID-training \
# --wandb_name pythia-1.4b_transcoder_erm_lr${lr}_lambda${lambda_sparse}
# done
# done